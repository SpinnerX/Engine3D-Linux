...
namespace Engine3DLinux{
	static b2BodyType engineRigidBody2DTypeToBox2DType(RigidBody2DComponent::BodyType type){
		switch (type) {
			case Engine3DLinux::RigidBody2DComponent::BodyType::Static: return b2_staticBody;
			case Engine3DLinux::RigidBody2DComponent::BodyType::Dynamic: return b2_dynamicBody;
			case Engine3DLinux::RigidBody2DComponent::BodyType::Kinematic: return b2_kinematicBody;
		}
