...
/* #include <Engine3DLinux/Core/KeyCodes.h> */
...
namespace Engine3DLinux{
	...
	void OrthographicCameraController::onEvent(Event& e){
		...
		dispatcher.Dispatch<MouseScrolledEvent>(Engine3DLinux::bind_function(this, &OrthographicCameraController::onMouseScrolled));
		dispatcher.Dispatch<WindowResizeEvent>(Engine3DLinux::bind_function(this, &OrthographicCameraController::onWindowResized));
	}
